 ...
 * Purpose: UNO V13
 * All bots work, Wild choice is broken because of where it prompts in the game
 * will need to move that into the respective classes
        ...
        case(WILD)://Wild
            do{//Input Validation
                if(typeid(*(plyr))==typeid(Hplayer)){ //If human
                    ...
                    colChc=static_cast<Cplayer*>(plyr)->wildPic();
                }
